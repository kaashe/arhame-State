    ...
    return (
        <div className='px-3 max-w-lg mx-auto'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 mb-2'>
                ...
                <input type="email" id='email' className={`border p-3 rounded-lg ${errors?.email ? 'border-red-400' : ""}`} placeholder="Email" {...register("email", { required: 'Email is required', pattern: /^\S+@\S+$/i })} />
